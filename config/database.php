    ...
    */
    'connections' => [
        ...
        'ordernow' => [
            ...
            'database' => env('DB_SECOND_DATABASE', 'ordernow'),
        ...
        'invoice' => [
            ...
            'database' => env('DB_THIRD_DATABASE', 'invoice'),
        ...
        'performance_schema' => [
            'driver' => 'mysql',
            'host' => env('DB_FOURTH_HOST', '127.0.0.1'),
            'port' => env('DB_FOURTH_PORT', '3306'),
            'database' => env('DB_FOURTH_DATABASE', 'performance_schema'),
        ...
        'innovate_now' => [
            ...
            'host' => env('DB_FOURTH_HOST', '127.0.0.1'),
            'port' => env('DB_FOURTH_PORT', '3306'),
            'database' => env('DB_FOURTH_DATABASE', 'innovate_now'),
            'username' => env('DB_FOURTH_USERNAME', 'root'),
            'password' => env('DB_FOURTH_PASSWORD', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
